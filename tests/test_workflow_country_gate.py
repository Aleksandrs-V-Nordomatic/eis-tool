...
class TheGateRefusesBeforeAnythingIsFetched(unittest.TestCase):
    ...
    def test_the_country_that_moved_out_is_refused(self):
        # The likeliest wrong input by far: a dispatch copied from before the split.
        code, err = run_gate("LT")
        self.assertEqual(code, 1)
        self.assertIn("epps-tool", err)
